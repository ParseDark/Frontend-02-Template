...
const JudgeNumType = str => {
    ...
    const result = Object.entries(regxMapType).find(([, reg]) => {
        return reg.test(str);
    });
...
console.log("result: ======> " + StringToNumber("0x11"));
console.log("result: ======> " + StringToNumber("0b100"));
console.log("result: ======> " + StringToNumber("011"));
