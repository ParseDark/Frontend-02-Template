// 1. go to www.w3.org/TR/?tag=css
// 2. open console
// 3. Json.stringify

var getData = () => {
    const arr = Array.prototype.slice.call(document.querySelector('#container').children).filter(e => e.getAttribute('data-tag').match(/css/)).map(e => ({ name: e.children[1].innerText, url: e.children[1].children[0].href }));
    return JSON.stringify(arr);
}

var standard = getData();
